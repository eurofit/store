...
export const site = {
  ...
  socialLinks: [
    ...
    },
    {
      ...
      icon: ({ className, ...props }: React.ComponentProps<typeof Whatsapp>) => (
        <Whatsapp data-slot="whatsapp" className={cn('size-4', className)} {...props} />
      ),
    },
    {
      name: 'Tiktok',
      ...
      icon: ({ className, ...props }: React.ComponentProps<typeof Tiktok>) => (
        <Tiktok data-slot="tiktok" className={cn('size-4', className)} {...props} />
      ),
    },
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/eurofitltd',
      icon: ({ className, ...props }: React.ComponentProps<typeof Instagram>) => (
        <Instagram data-slot="instagram" className={cn('size-4', className)} {...props} />
      ),
    },
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/eurofitltd',
      icon: ({ className, ...props }: React.ComponentProps<typeof Facebook>) => (
        <Facebook data-slot="facebook" className={cn('size-4', className)} {...props} />
      ),
    },
    {
      name: 'Twitter',
      ...
      icon: ({ className, ...props }: React.ComponentProps<typeof Twitter>) => (
        <Twitter data-slot="twitter" className={cn('size-4', className)} {...props} />
      ),
    },
    {
      name: 'Youtube',
      ...
      icon: ({ className, ...props }: React.ComponentProps<typeof Youtube>) => (
        <Youtube data-slot="youtube" className={cn('size-4.5', className)} {...props} />
      ),
    },
  ],
  address: {
