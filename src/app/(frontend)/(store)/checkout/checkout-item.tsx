...
export function CheckoutItem({
  ...
  return (
    <div className="relative space-y-4">
      {item.price !== item.snapshot.retailPrice && (
        <div className="text-amber-500">Price has been changed.</div>
      )}
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="space-y-6">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  >
                    <Button
                      ...
                      disabled={qty <= 0 || item.isOutOfStock}
                    >
                    ...
                    <Button
                      ...
                      disabled={qty >= item.stock || item.isOutOfStock}
                    >
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                {item.isBackorder && !item.isOutOfStock && (
                  <>
                    <div className="flex gap-2">
                      <Clock3 className="text-muted-foreground size-4" />
                      <span className="text-muted-foreground text-xs">
                        Ships in 7&ndash;14 days
                      </span>
                    </div>
                  </>
                )}
            ...
            {item.price && (
              <div className="flex flex-col self-end text-right lining-nums tabular-nums">
